...
module.exports = {
  ...
  create(context) {
    ...
    function getParentIgnoringBinaryOrLogicalOrConditionalExpressions(node) {
      let current = node;
      while (['BinaryExpression', 'LogicalExpression', 'ConditionalExpression'].includes(current.parent.type)) {
    ...
    function getValidation(node) {
      ...
      const parent = getParentIgnoringBinaryOrLogicalOrConditionalExpressions(node);
